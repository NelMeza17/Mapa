...
<?php
	require_once "load/head.php";
		$result=mysql_query("select * from productos where coordenadas='".$_GET['coordenadas']."'",$link);
		$tienda="";
		$informacion="";
		...
		<script type='text/javascript'>
		  ...
		  function initialize() {
			...
			image = 'tienda.png';
			var cor= new google.maps.LatLng(".$_GET['coordenadas'].");
			placeMarker(cor);
		  		...
		  		<div id="izquierda">
		  			<a href="dentro.php"><div id="izquierda_banner"></div></a>
		  				...
		  				<fieldset style="border-color: #A9A9F5">
			  				...
			  				<form id="formulario" action="sube_producto.php" method="post">
			  					<label>Producto: </label><input type="text" name="producto" required /><br /><br />
			  					<input type="submit" name="enviar" value="Enviar" />
			  					<? echo "<input type='hidden' name='coordenadas' value='".$_GET['coordenadas']."' />";?>
			  				</form>
		  				</fieldset>
		  				<br /><br /><br /><br /><br /><br />
