<head>
	<?php
		$ruta = "http://localhost/Mapa/";
	?>
	<meta charset="UTF-8">
	<title>LocaTienda</title>
	<link rel="stylesheet" type="text/css" href="<?=$ruta?>css/estilo.css" />
	<link href='<?=$ruta?>images/icono.png' rel='shortcut icon' type='image/png'/>
	<script type="text/javascript" src="<?=$ruta?>js/jquery-1.3.2.min.js"></script>
